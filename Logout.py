...
login_form.markdown("<img style='display: block; margin-left: auto; margin-right: auto; width:40%;' src='https://firebasestorage.googleapis.com/v0/b/prodesex-8e59f.appspot.com/o/Imagens%2Fdepsmrj.png?alt=media&token=bc3a82e2-776e-4786-8968-bd1e58fe5a60' alt='DepSMRJ' width='500'>", unsafe_allow_html=True)
